...
<%
    ...
    String query = "SELECT * FROM `peralatan` ORDER BY tarikh ASC";
...
<html>
    ...
    <body>
        <ul>
            <li><a href="peralatan_papar_admin.jsp" title="Kembali ke Laman Utama!" ><span id="left" class="material-symbols-outlined">navigate_before</span></a></li>
    ...
    <center>
        ...
        <form method="post" action="peralatan_delete_admin_berjaya.jsp">
            <table>

                <tr>
                    <td> <label>Masukkan ID Peralatan </label> </td>
                    <td> <select name="id" id="nama1">
                            <%                while (rs.next()) {%>

                            <option value="<%=rs.getString("idPeralatan")%>"><%=rs.getString("idPeralatan")%></option>
